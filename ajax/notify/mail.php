<ul class="notification-body">
	<li>
		<span class="unread">
			<a href="javascript:void(0);" class="msg">
				<img  src="http://localhost:7777/git-smart-ci/img/avatars/4.png" alt="" class="air air-top-left margin-top-5" width="40" height="40" />
	...
	<li>
		<span>
			<a href="javascript:void(0);" class="msg">
				<img  src="http://localhost:7777/git-smart-ci/img/avatars/female.png" alt="" class="air air-top-left margin-top-5" width="40" height="40" />
	...
	<li>
		<span>
			<a href="javascript:void(0);" class="msg">
				<img  src="http://localhost:7777/git-smart-ci/img/avatars/1.png" alt="" class="air air-top-left margin-top-5" width="40" height="40" />
	...
	<li>
		<span>
			<a href="javascript:void(0);" class="msg">
				<img  src="http://localhost:7777/git-smart-ci/img/avatars/male.png" alt="" class="air air-top-left margin-top-5" width="40" height="40" />
	...
	<li>
		<span class="unread">
			<a href="javascript:void(0);" class="msg">
				<img  src="http://localhost:7777/git-smart-ci/img/avatars/sunny.png" alt="" class="air air-top-left margin-top-5" width="40" height="40" />
